define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>Este metodo sirve para agregar imagenes a un capitulo, si se detecta que el programa al que pertenece el capitulo no tiene imagenes (default) la iamgen subida es posicionada como tal y los posteriores capitulos tendran como imagen default la proporcinada en esta API</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
