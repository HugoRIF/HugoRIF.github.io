define({ "api": [
  ...
  {
    "type": "post",
    "url": "/section/setImageSlider",
    "title": "Agregar Imagenes al Carrusel",
    "version": "1.0.0",
    "name": "Agregar_al_carrusel",
    "group": "Seccion",
    "permission": [
      {
        "name": "admin"
    ...
    "description": "<p>Metodo para agregar imagenes al carrusel principal del landing indicado,las iamgenes se suben por un medio diferente, esta api solo recibe la url de la image que se agregara y la posicion en la que se agregara.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "value",
            "description": "<p>Arreglo con las urls de las imagenes</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "positions",
            "description": "<p>Posiciones en la que estarán las imagenes</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "landing",
            "description": "<p>Nombre del landing que se quiere editar</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "schedule_date",
            "description": "<p>Hora en la que se empezara a mostrar (No desarrollado por complete, se muestran de inmediato)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "description": "<p>Ultimo dia en el que aparecerán (No desarrollado por complete, se muestran de inmediato)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "NotFound-landing",
            "description": "<p>No se encontro el landing.</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Response (NotFound-User):",
          "content": "{\n \"code\":404,\n \"message\":\"No tienes permiso para hacer esto\"\n \"data\" : {\n    \n }\n}",
          "type": "json"
        },
        {
          "title": "Response (NotFound-landing):",
  ...
  {
    "type": "post",
    "url": "/section/editBlock1Home",
    "title": "Editar el Bloque 1 HOME",
    "version": "1.0.0",
    "name": "Editar_Bloque_1_del_home",
    "group": "Seccion",
    "permission": [
      {
        "name": "admin"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "title",
            "description": "<p>Titulo principal del home (Color azul)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "subtitle",
            "description": "<p>Titulo secundario del home (Color negro)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "video",
            "description": "<p>URL del video promocional del home</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": false,
            "field": "images",
            "description": "<p>Imagenes para el carrusel del home en la version movil</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": false,
            "field": "positions",
            "description": "<p>Posiciones para las imagenes del carrusel en la version movil</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "inicio",
            "description": "<p>Fecha de inicio en el que se mostrarán los cambios (No desarrollado aun, los cambios se mantienen hasta que se vuelca a editar)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "fin",
            "description": "<p>Fecha de fin en el que se muestrán los cambios (No desarrollado aun, los cambios se mantienen hasta que se vuelca a editar)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/section/editBlockChannelHome",
    "title": "Editar el Bloque de canal HOME",
    "version": "1.0.0",
    "name": "Editar_Bloque_1_progrmación",
    "group": "Seccion",
    "permission": [
      {
        "name": "admin"
  ...
  {
    "type": "post",
    "url": "/version/aprobarVersion",
    "title": "Aprobar versión",
    "version": "1.0.0",
    "name": "Aprobar_versión",
    "group": "Versiones",
    "permission": [
      {
        "name": "admin-approver"
    ...
    "description": "<p>Este metódo aprueba la versión indicada e integra los cambios a la versión maestra para que el publico vea los cambios.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "usuario_id",
            "description": "<p>Id del adminsitrador que aprobará la version</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
            "optional": false,
            "field": "version_id",
            "description": "<p>id de la version a aprobar</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/version/sendRevisionLanding",
    "title": "Enviar a Revision Landing",
    "version": "1.0.0",
    "name": "Enviar_a_Landing",
    "group": "Versiones",
    "permission": [
      {
        "name": "admin"
    ...
    "description": "<p>Se envia a revisión la version abierta del landing indicado.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "usuario_id",
            "description": "<p>Id del adminsitrador que envia sus versiones a revision</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
            "optional": false,
            "field": "landing_id",
            "description": "<p>id del landing</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/version/sendRevisionAll",
    "title": "Enviar a Revision Todas",
    "version": "1.0.0",
    ...
    "description": "<p>Se envian a revisión todas las versiones abiertas que el usuario que realiza la petición tenga.Los estados de todas las versiones cambian a 'En revision', los cambios que se realizen posteriormente de usar esta API se guardaran en una nueva version</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/version/history/{id}",
    "title": "Obtener Historial de versiones",
    "version": "1.0.0",
    "name": "Historial",
    "group": "Versiones",
    "permission": [
  ...
  {
    "type": "post",
    "url": "/version/declineVersion",
    "title": "Rechazar Version",
    "version": "1.0.0",
    "name": "Rechazar",
    "group": "Versiones",
    "permission": [
    ...
    "description": "<p>Despues de que un editor mande a revisión, algún aprobador debe realizar la revision para integrar los cambios, en el caso en que dichos cambios tengan alguna situación el aprobador rechaza la versión para que el editor corrija o realice los cambios necesarios.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "version_id",
            "description": "<p>Id de la versión que se rechaza</p>"
          },
          {
            "group": "Parameter",
            "type": "Text",
            "optional": false,
            "field": "comments",
            "description": "<p>Comentarios o motivos del rechazo</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "BadRequest",
            "description": "<p>Error en validación de parametros.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>Eliminar una version, solo se puede eliminar una version propia no de otros usuarios</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
